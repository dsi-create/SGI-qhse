...
export function AppFooter() {
  ...
  return (
    <footer className="mt-auto border-t border-slate-200/80 bg-[hsl(var(--brand-navy))] text-white">
          ...
          <div className="lg:col-span-2 space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-cyan-200/90">Système de Gestion Intégré</p>
              </div>
            </div>
            ...
            <div className="flex gap-3 pt-1">
              <a
                ...
                className="inline-flex h-9 w-9 items-center justify-center rounded-full bg-white/10 text-cyan-200 transition hover:bg-cyan-500 hover:text-white"
                aria-label="Email"
              >
            ...
            <div key={column.title}>
              ...
              <ul className="space-y-2.5">
                {column.links.map((link) => (
                  <li key={link.label}>
                    <span className="text-sm text-slate-300 transition hover:text-white cursor-default">
                      {link.label}
                    </span>
                  </li>
                ))}
