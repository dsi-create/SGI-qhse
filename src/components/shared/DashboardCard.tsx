...
export const DashboardCard = ({ title, value, iconName, colorClass, onClick }: DashboardCardProps) => {
  ...
  return (
    <Card
      className={cn(
        "card-hover overflow-hidden border-slate-300 bg-white",
        ...
        <CardContent className="p-5 md:p-6">
          <div className="flex items-center justify-between gap-3">
            <div className="min-w-0 flex-1">
              <p className="mb-1 text-[11px] font-semibold uppercase tracking-[0.12em] text-slate-600 md:text-xs">
                {title}
              </p>
            ...
            <div
              className={cn(
                "flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl ring-1 ring-black/5 md:h-14 md:w-14",
                colorClass,
              )}
            >
          ...
          {isClickable && (
            <div className="mt-4 flex items-center border-t border-slate-200 pt-3 text-xs font-semibold text-cyan-700">
